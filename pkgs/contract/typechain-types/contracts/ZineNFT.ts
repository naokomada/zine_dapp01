...
export interface ZineNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ZineNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ZineNFT;
  waitForDeployment(): Promise<this>;

  interface: ZineNFTInterface;
